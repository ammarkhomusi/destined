    ...
    >
      ...
      <View style={styles.options}>
        <TouchableOpacity style={styles.optionOne}>
          <Text style={styles.optionOneText}>GLASS OF WINE</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionTwo}>
          <Text style={styles.optionTwoText}>CUP OF TEA</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionThree}>
          <Text style={styles.optionThreeText}>MAI THAI COCKTAIL</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionFour}>
          <Text style={styles.optionFourText}>PINT OF BEER</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.bottom}>
        <View style={styles.next}>
          <TouchableOpacity
            onPress={() => navigation.push("QuestionnairePageSix")}
          >
