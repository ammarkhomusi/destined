  ...
  return (
    ...
    >
      <View style={styles.top}>
        <TouchableOpacity
          onPress={() => navigation.push("QuestionnairePageOne")}
        >
          <Image
            style={styles.back}
      ...
      <View style={styles.options}>
        <TouchableOpacity style={styles.optionOne}>
          <Text style={styles.optionOneText}>THE BEACH</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionTwo}>
          <Text style={styles.optionTwoText}>THE COUNTRYSIDE</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionThree}>
          <Text style={styles.optionThreeText}>THE JUNGLE</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionFour}>
          <Text style={styles.optionFourText}>THE CITY</Text>
        </TouchableOpacity>
      </View>
