  ...
  return (
    ...
    >
      <View style={styles.top}>
        <TouchableOpacity
          onPress={() => navigation.push("QuestionnairePageTwo")}
        >
          <Image
            style={styles.back}
      ...
      <View style={styles.options}>
        <TouchableOpacity style={styles.optionOne}>
          <Text style={styles.optionOneText}>EXOTIC, SURPRISING & SERENE</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionTwo}>
          <Text style={styles.optionTwoText}>
            ADVENTUROUS, FUN & UNDISCOVERED
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionThree}>
          <Text style={styles.optionThreeText}>
            LUXURIOUS, SLOW-PACED & BEAUTIFUL
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionFour}>
          <Text style={styles.optionFourText}>
            EDUCATIONAL, CULTURAL & AMUSING
          </Text>
        </TouchableOpacity>
      </View>
      <View style={styles.bottom}>
        <View style={styles.next}>
          <TouchableOpacity
            onPress={() => navigation.push("QuestionnairePageFour")}
          >
