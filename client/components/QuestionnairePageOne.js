  ...
  return (
    ...
    >
      ...
      <Text style={styles.question}>
        What activity would you most likely do?
      </Text>
      <View style={styles.options}>
        <TouchableOpacity style={styles.optionOne}>
          <Text style={styles.optionOneText}>VISIT MUSEUMS</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionTwo}>
          <Text style={styles.optionTwoText}>EXPLORE TEMPLES</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionThree}>
          <Text style={styles.optionThreeText}>TREK IN THE MOUNTAINS</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionFour}>
          <Text style={styles.optionFourText}>SUNBATHE ON A BEACH</Text>
        </TouchableOpacity>
      </View>
